    ...
    <div className="w-full flex flex-col h-full bg-surface">
      ...
      <div className="flex items-center justify-between px-3 py-3.5 min-h-[56px]">
        <button
          ...
          className="flex items-center gap-2.5 group overflow-hidden cursor-pointer"
        >
          ...
          <span className={`text-sm font-medium text-white/80 group-hover:text-white whitespace-nowrap transition-all duration-300 ${collapsed ? 'opacity-0 max-w-0 overflow-hidden pl-0' : 'opacity-100 max-w-[200px] pl-0'}`}>
            DocsChat
          </span>
        </button>
      ...
      <div className="px-3 pt-3 pb-2">
        <button
          ...
          className="w-full bg-white/[0.06] hover:bg-white/[0.1] text-white/70 hover:text-white py-2.5 rounded-lg flex items-center justify-center gap-2 text-sm transition-all cursor-pointer"
        >
      ...
      {/* Sources header */}
      <div className={`overflow-hidden transition-all duration-300 ${collapsed ? 'max-h-0 opacity-0 py-0' : 'max-h-8 opacity-100'}`}>
      ...
      {/* Source list */}
      <div className={`overflow-hidden transition-all duration-300 ${collapsed ? 'max-h-0 opacity-0' : 'flex-1 max-h-[2000px] opacity-100'} px-1.5 pb-2`}>
        {loading ? (
      ...
      {/* Spacer when collapsed to push avatar to bottom */}
